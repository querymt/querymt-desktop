...
export type SendShortcutKind = 'enter' | 'shift-enter' | 'ctrl-enter' | 'cmd-enter';
 ...
 */
export function buildKeybindings(sendShortcut: SendShortcutKind = 'enter'): KeybindingEntry[] {
  const sendKeys: Record<SendShortcutKind, string[]> = {
    enter: ['Enter'],
    'shift-enter': ['Shift', 'Enter'],
    'ctrl-enter': ['Ctrl', 'Enter'],
    'cmd-enter': ['Cmd', 'Enter']
  };
  const newLineKeys: Record<SendShortcutKind, string[]> = {
    enter: ['Shift', 'Enter'],
    'shift-enter': ['Enter'],
    'ctrl-enter': ['Enter'],
    'cmd-enter': ['Enter']
  ...
  return [
    ...
    { keys: sendKeys[sendShortcut], label: 'Send prompt', scope: 'composer' },
    { keys: newLineKeys[sendShortcut], label: 'New line in prompt', scope: 'composer' }
  ];
}

export const KEYBINDINGS: KeybindingEntry[] = buildKeybindings('enter');
